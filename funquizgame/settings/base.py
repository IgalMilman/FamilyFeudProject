"""
Django settings for funquizgame project.
...
ROOT_URLCONF = 'funquizgame.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
                join(dirname(funquizgame.__file__), 'templates'),
        ],
        'OPTIONS': {
            'context_processors': [
                ...
                'funquizgame.context_processors.global_settings',
            ],
            'loaders':[
