...
api_urlpatterns = [
    ...
    path('api/survey/<uuid:gameid>/<uuid:survey_id>', survey_api.get_survey_api, name='api_get_survey_for_game'),
    path('api/survey/all', survey_api.get_all_surveys_api, name='api_get_all_surveys'),
    path('api/survey/<uuid:gameid>/surveys/<uuid:survey_id>/answers', survey_api.get_all_surveys_with_answers_api, name='api_get_survey_with_answers'),
    path('api/survey/upsert', survey_api.upsert_survey_api, name='api_upsert_survey'),
    path('api/survey/<uuid:gameid>/surveys/<uuid:survey_id>/answer/upsert', survey_api.upsert_survey_answer_api, name='api_upsert_survey_answer'),
]